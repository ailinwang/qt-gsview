...
QString QtUtil::getAppsPath()
{
    return getRealAppDirPath() + QString("apps");
}
...
//  code below is no longer used because we modify PATH instead.
//#ifdef  _QT_WIN
...
QString QtUtil::getLastOpenFileDir()
{
...
void QtUtil::setLastOpenFileDir(QString val)
{
